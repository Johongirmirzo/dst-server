...
const RegisterController = {
    ...
    loginUser: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const accessToken = (0, utils_1.generateToken)({ id: currentUser._id, username: currentUser.username }, `${process.env.ACCESS_TOKEN_EXPIRATION_TIME}`);
        const refreshToken = (0, utils_1.generateToken)({ id: currentUser._id, username: currentUser.username }, `${process.env.REFRESH_TOKEN_EXPIRATION_TIME}`);
